# Generated by Django 2.2 on 2019-05-27 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dttm_created', models.DateTimeField(default=datetime.datetime.now)),
                ('dttm_deleted', models.DateTimeField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bought_items', models.ManyToManyField(to='item.Item')),
                ('campaign', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='item.MarketingCampaign')),
